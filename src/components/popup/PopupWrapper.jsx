...
const PopupWrapper= ({ children, title, hide }) => {
  return (
    <div className="fixed top-0 left-0 z-20 w-full h-full flex items-center justify-center">
      <div className="w-full h-full absolute glass-effect" onClick={hide}></div>
      ...
      <div className="flex flex-col w-[500px] max-h-[80%] min-h-[600px] bg-c2 relative z-10 rounded-3xl">
        <div className="shrink-0 p-6 flex items-center justify-between">
          ...
          <Icon size="small" icon={<IoClose size={20} />} onClick={hide} />
        </div>
